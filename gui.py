...
# Top Widgets
# =============
saveSetting = Button(top, text=' Save Settings ', command=Save, highlightbackground="#212121", fg='#FFFFFF')
saveSetting.grid(row=0, column=16, sticky=S)
loadSetting = Button(top, text=' Load Settings ', command=Load, highlightbackground="#212121", fg='#FFFFFF')
loadSetting.grid(row=0, column=17,columnspan=2, sticky=S)
# addSetting = Button(top, text='Add Setting', command=Add)
# addSetting.grid(row=0, column=21)

importBtn = Button(top, text='  Import CSV   ', command=Import, highlightbackground="#212121", fg='#FFFFFF')
importBtn.grid(row=0, column=20, sticky=S)
exportBtn = Button(top, text='   Export CSV   ', command=Export, highlightbackground="#212121", fg='#FFFFFF')
exportBtn.grid(row=0, column=21, sticky=S)

optimizeBtn = Button(top, text='Optimize', font=('Times New Roman',15, 'bold'), height=2, width=25, command=Optimize, highlightbackground="#212121", fg='#FFFFFF')
optimizeBtn.grid(row=12, rowspan=2, column=17, columnspan=5)
...
createConfig.config(highlightbackground="#212121", fg='white')
createConfig.grid(row=15,columnspan=2, sticky=E)

#Load Preset configuration from drop down menu
presetLabel = Label(top, text='Presets: ',bg="#212121", fg='#FFFFFF')
presetLabel.grid(row = 13,column = 2, sticky = W)
presetDropMenu = CreateDropMenu(top, 'Select Status',settings.presetConfigList)
presetDropMenu.grid(row = 13, column = 4, sticky = W)
...
loadPreset = Button(top, text='Load Preset', command=loadPresetConfig, highlightbackground="#212121", fg='#FFFFFF')
loadPreset.grid(row=13, column=14, columnspan=3, sticky = W)
